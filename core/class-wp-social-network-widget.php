...
<!--  linear gradient tl 5442d4 mid d52472 br fec053 -->
  <li data-order="<?php echo $this->options->get('instagram_url_order', '1'); ?>" class="<? if (! $this->options->get('instagram_url_check') ) echo 'd-none'; ?>"><a class="icon_15 instagram" href="<?php echo $this->options->get('instagram_url','instagram.def'); ?>" title="<?php bloginfo('name'); ?> on Instagram">
      <section class="intrinsic_ratio">
<svg viewbox="0 0 512 512" preserveAspectRatio="xMidYMid meet">
<linearGradient gradientTransform="scale(0.92916227)" gradientUnits="userSpaceOnUse" y2="0" x2="512" y1="0" x1="0" id="INSTASVG_1_">
  <stop id="stop2" style="stop-color:#E09B3D" offset="0" />
  <stop id="stop4" style="stop-color:#C74C4D" offset="0.3" />
  <stop id="stop6" style="stop-color:#C21975" offset="0.6" />
  <stop id="stop8" style="stop-color:#7024C4" offset="1" />
</linearGradient>
<path id="path11" d="M 359.47244,0 H 152.52756 C 68.423509,0 0,68.423509 0,152.52756 V 359.47244 C 0,443.57649 68.423509,512 152.52756,512 H 359.47244 C 443.57649,512 512,443.57649 512,359.47244 V 152.52756 C 511.99907,68.423509 443.57556,0 359.47244,0 Z m 101.02038,359.47244 c 0,55.79155 -45.22883,101.02038 -101.02038,101.02038 H 152.52756 c -55.791547,0 -101.020379,-45.22883 -101.020379,-101.02038 V 152.52756 c 0,-55.792477 45.228832,-101.020379 101.020379,-101.020379 h 206.94488 c 55.79155,0 101.02038,45.227902 101.02038,101.020379 z"
   style="fill:url(#INSTASVG_1_);stroke-width:0.929162"></path>
<linearGradient gradientUnits="userSpaceOnUse" y2="128" x2="384" y1="128" x1="128"
   gradientTransform="matrix(1.0000018,0,0,1.0000018,-19.517,-19.5165)" id="INSTASVG_2_">
  <stop id="stop13" style="stop-color:#E09B3D" offset="0" />
  <stop id="stop15" style="stop-color:#C74C4D" offset="0.3" />
  <stop id="stop17" style="stop-color:#C21975" offset="0.6" />
  <stop id="stop19" style="stop-color:#7024C4" offset="1" />
</linearGradient>
<path id="path22" d="m 256,113.4835 c -78.584,0 -142.517,63.933 -142.517,142.516 0,78.583 63.933,142.517 142.517,142.517 78.584,0 142.517,-63.933 142.517,-142.517 0,-78.584 -63.933,-142.516 -142.517,-142.516 z m 0,229.6 c -48.095,0 -87.083,-38.988 -87.083,-87.083 0,-48.095 38.989,-87.083 87.083,-87.083 48.095,0 87.083,38.988 87.083,87.083 0,48.094 -38.989,87.083 -87.083,87.083 z" style="fill:url(#INSTASVG_2_)"></path>
<linearGradient id="INSTASVG_3_" />
<stop id="stop25" style="stop-color:#e09b3d" offset="0" />
<stop id="stop27" style="stop-color:#c74c4d" offset="0.3" />
<stop id="stop29" style="stop-color:#c21975" offset="0.6" />
<stop id="stop31" style="stop-color:#7024c4" offset="1" />
</svg>
      </section></a></li>
